...
namespace mtm {
	...
	private:
		...
		constexpr static const double EPSILON = 10e-6;
		constexpr static const double HALF_HOUR = 0.5;
		static const int MTM_EXAM_MONTH = 7;
		static const int MTM_EXAM_DAY = 28;
		static const int MTM_NUMBER_COURSE = 234124;
		constexpr static const double MTM_COURSE_TIME = 13.0;
		constexpr static const double MTM_EXAM_LENGTH = 3.0;
		constexpr static const char* MTM_COURSE_LINK = "https://tinyurl.com/59hzps6m";
	...
	public:
		...
		ExamDetails(int num_course, int day, int month, double time, double exam_length,
					const std::string& link_to_exam = " ");
...
///ask the dan
	...
	std::ostream& operator<<(std::ostream& os, const ExamDetails& c);
}
